...
import com.ihr.domain.system.response.RoleResult;
...
public class RoleController extends BaseController {
    ...
    public Result findById(@PathVariable(name = "id") String id) throws Exception {
        ...
        return new Result(ReturnCode.SUCCESS,roleResult);
    }
    ...
    public Result findByPage(int page,int pagesize,Role role) throws Exception {
        ...
        return new Result(ReturnCode.SUCCESS,pr);
    }

    @RequestMapping(value="/role/list" ,method=RequestMethod.GET)
    public Result findAll() throws Exception {
        List<Role> roleList = roleService.findAll(companyId);
        return new Result(ReturnCode.SUCCESS,roleList);
    }
}

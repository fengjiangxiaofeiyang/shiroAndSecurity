...
-- Records of bs_user
-- ----------------------------
INSERT INTO `bs_user` VALUES ('1063705482939731968', '13800000001', 'cgx', '123456', NULL, '2018-11-17 16:08:44', '', '2018-11-01 08:00:00', 1, '', NULL, NULL, '2018-11-01 00:00:00', 2, '', '', '', 'saasAdmin', NULL);
INSERT INTO `bs_user` VALUES ('1063705989926227968', '13800000002', 'aj123', '123456', 1, '2018-11-17 16:10:45', '1066241293639880704', '2018-11-02 08:00:00', 1, '9002', NULL, NULL, '2018-11-30 00:00:00', 2, '1', '传智播客', 'test1', 'coAdmin', 'http://pkbivgfrm.bkt.clouddn.com/1063705989926227968?t=1545788007343');
INSERT INTO `bs_user` VALUES ('1066370498633486336', '13800000003', 'zbz', '123456', 1, NULL, '1063678149528784896', '2018-11-04 08:00:00', 1, '111', NULL, NULL, '2018-11-20 00:00:00', 2, '1', '传智播客', '测试部', 'user', 'http://pkbivgfrm.bkt.clouddn.com/1066370498633486336?t=1545812322518');
INSERT INTO `bs_user` VALUES ('1071632760222810112', '13800000004', 'll', '123456', 1, NULL, '1063678149528784896', '2018-12-02 08:00:00', 1, '1111', NULL, NULL, '2018-12-31 00:00:00', 2, '1', '传智播客', '测试部', 'user', NULL);
...
-- ----------------------------
INSERT INTO `co_company` VALUES ('1', '江苏传智播客教育科技股份有限公司', 'abc', '12', '2020-06-16 09:44:46', '2020-06-16 09:44:49', '武汉市', '光谷', 'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg', '张三', '15327327602', '469821953@qqc.om', '100人', '教育', 'abc', '0', 1, 0, '2018-11-07 13:30:05');
INSERT INTO `co_company` VALUES ('1060043412612452352', 'zhangsan', 'abc', '12', '2020-06-16 09:45:38', '2020-06-16 09:45:29', '宜昌市', '汉阳', 'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg', '刘嘉威', '15327327602', '469821953@qqc.om', '50人', '放高利贷', 'abc', '0', 1, 0, '2018-11-07 13:36:58');
INSERT INTO `co_company` VALUES ('1061532681482932224', 'zhangsan', 'abc', '12', '2020-06-16 09:45:40', '2020-06-16 09:45:31', '荆门市', '洪山', 'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg', '关刚', '15327327602', '469821953@qqc.om', '20人', 'it科技', 'abc', '0', 1, 0, '2018-11-11 16:14:48');
INSERT INTO `co_company` VALUES ('1065494996154650624', '江苏传智播客教育股份有限公司', 'abc', '12', '2020-06-16 09:45:43', '2020-06-16 09:45:34', '恩施市', '猪脚坝', 'https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg', '杨春', '15327327602', '469821953@qqc.om', '39人', '影视', 'abc', '0', 1, 0, '2020-06-16 09:47:08');
...
INSERT INTO `co_department` VALUES ('1272730991121530880', '1', '', 'aaa', 'aa', 'aa', 'aaaaa', NULL, NULL);
INSERT INTO `co_department` VALUES ('1272731057035018240', '1', '', 'aaaaaaaaaaaaaaaa', 'aa', 'aa', 'aa', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pe_permission` VALUES ('1', '3', 'SAAS企业管理', 1, '0', 'company', 0);
INSERT INTO `pe_permission` VALUES ('1063313020819738624', '查看部门的按钮', '查看部门', 2, '1', 'point-dept', 1);
INSERT INTO `pe_permission` VALUES ('1063315016368918528', '用户管理菜单', '员工管理', 1, '0', 'employee', 1);
...
INSERT INTO `pe_permission` VALUES ('1063327833876729856', '组织架构菜单', '组织架构', 1, '0', 'department', 1);
...
INSERT INTO `pe_permission` VALUES ('1064104257952813056', NULL, '权限管理', 1, '0', 'permissions', 0);
INSERT INTO `pe_permission` VALUES ('1064553683007705088', 'test', 'test', 1, '0', 'saas-demo', 1);
INSERT INTO `pe_permission` VALUES ('1067396481381625856', '啊啊啊', '啊啊啊', 1, '0', '啊啊啊', 1);
INSERT INTO `pe_permission` VALUES ('2', '公司选择框', '公司选择框', 2, '1063327833876729856', 'select-company-select', 1);
...
CREATE TABLE `pe_permission_point`  (
  `id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键ID',
  `point_class` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮类型',
  `point_icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮icon',
...
-- ----------------------------
INSERT INTO `pe_permission_point` VALUES ('1', 'select-company-select', 'select-company-select', 1);
